...
public class Main {
	...
	public static void main(String[] args) {
		...
		caneta1.tampada = false; //Atribuindo um novo valor para o atributo 'tampada'. (diferente do que está na classe modelo [isso consta nas diferenças mudanças de estado que um objeto pode ter])
